...
In this (final!) chapter, we reviewed the assumptions underlying multilevel models and examined some methods to assess them. 

## Parting Words

This is the last chapter of the book! If you have any suggestions or feedback, feel free to get in touch on Twitter ([Mairead](www.twitter.com/maireadkshaw), [Jessica](www.twitter.com/jkayflake)) or on [GitHub](https://github.com/mkshaw/learn-mlms).
